...
export const api_v1_items_list = createAsyncThunk("items/api_v1_items_list", async payload => {
  const response = await apiService.api_v1_items_list(payload);
  return response.data;
});
export const api_v1_items_create = createAsyncThunk("items/api_v1_items_create", async payload => {
  const response = await apiService.api_v1_items_create(payload);
  return response.data;
});
export const api_v1_items_retrieve = createAsyncThunk("items/api_v1_items_retrieve", async payload => {
  const response = await apiService.api_v1_items_retrieve(payload);
  return response.data;
});
export const api_v1_items_update = createAsyncThunk("items/api_v1_items_update", async payload => {
  const response = await apiService.api_v1_items_update(payload);
  return response.data;
});
export const api_v1_items_partial_update = createAsyncThunk("items/api_v1_items_partial_update", async payload => {
  const response = await apiService.api_v1_items_partial_update(payload);
  return response.data;
});
export const api_v1_items_destroy = createAsyncThunk("items/api_v1_items_destroy", async payload => {
...
const itemsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_items_list.pending, (state, action) => {
